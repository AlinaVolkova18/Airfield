...
namespace Airfield_C_
{
    partial class Reference
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox1.Size = new System.Drawing.Size(600, 115);
            this.textBox1.TabIndex = 3;
            this.textBox1.Text = "В этой программе пользователь может наблюдать замечательную работу диспетчера, ко" +
    "торая заключается в контроле взлета и посдаки двух летательных аппаратов: вертол" +
    "етов и самолетов.\r\n";
            // 
            // Reference
            // 
